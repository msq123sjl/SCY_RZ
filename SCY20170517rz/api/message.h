...
#define CN_Adjust                  3011
#define CN_Sample                 3012
#define CN_Control                3013
#define CN_SampleTime                  3014
#define CN_RST                       3015
...
public:
    ...
    int    messageProc(QString str,QextSerialPort *com,QTcpSocket *tcpe);
